    ...
    <div className="relative overflow-hidden">
      ...
      {sale.banner_image_url ? (
        <>
          ...
          />
          <div className="absolute inset-0" style={{ background: 'rgba(8,46,43,0.82)' }} />
        </>
      ) : (
        <div
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-6">
        {/* Sale label */}
