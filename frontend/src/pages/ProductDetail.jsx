  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-burgundy-600">Loading product...</p>
      </div>
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-md mb-4 aspect-square">
              {activeImg ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-burgundy-50 to-burgundy-100">
                  <svg className="w-20 h-20 text-burgundy-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="text-burgundy-400 mt-3">No image available</span>
                </div>
              )}
            </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="border-t border-gray-100 pt-6 mt-auto space-y-3">
              ...
              <Link
                to="/shop"
                className="flex items-center justify-center gap-2 w-full border-2 border-burgundy-500 text-burgundy-600 hover:bg-burgundy-500 hover:text-white font-semibold py-3 px-6 rounded-full transition-all duration-300"
              >
                ← Continue Shopping
              </Link>
            </div>
            ...
            {/* Delivery note */}
            <div className="mt-6 bg-burgundy-50 rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                <p className="text-burgundy-700 text-sm font-medium">Order & Delivery</p>
                <p className="text-burgundy-600 text-xs mt-1">Place your order via WhatsApp and we'll confirm availability and arrange delivery for you. Nationwide delivery available.</p>
              </div>
            </div>
          </div>
        </div>
